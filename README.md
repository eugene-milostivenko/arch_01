...
- Управление умными устройствами
  ...
  - [ACL] Интеграция с вендорами
    - MQTT-брокер (приём телеметрии и отправка команд)
...
- Сложность развёртывания: отдельное обновление мудулей невозможно
- Сложность масштабирования: для быстрого развития продукта, вероятно, потребуется найм новых сотрудников и выделение новых команд для доменов (сервисов), монолит не будет соответствовать структуре организации
- Снижение надёжности: с ростом функционала может расти количество ошибок, для монолита это может означать падение всей системы
